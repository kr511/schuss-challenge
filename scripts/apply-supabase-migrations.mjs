...
const migrationFiles = [
  ...
  '0013_profile_stats_columns.sql',
  '0014_leaderboard_sync_trigger.sql',
  '0015_user_progress_trigger.sql',
  '0016_missing_indexes.sql',
  '0017_game_sessions_discipline.sql',
];
