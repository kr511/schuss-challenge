...
test.describe('mobile dashboard', () => {
  ...
  test('fresh boot does not show a service-worker update toast', async ({ page, baseURL }) => {
    await page.goto(new URL('/offline.html', baseURL).toString(), { waitUntil: 'domcontentloaded' });
    ...
    await expect(page.locator('#swUpdateToast')).toHaveCount(0);
  });
