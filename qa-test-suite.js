 ...
 *
 * Production guard: this file may still be referenced by index.html,
 * but it should only run during local development.
 */

const QA_IS_LOCAL_DEV = ['localhost', '127.0.0.1', '::1'].includes(window.location.hostname);

if (!QA_IS_LOCAL_DEV) {
  console.info('🧪 QA Test Suite skipped outside local development');
} else {
